...
], CustomDesignsController.prototype, "byUser", null);
CustomDesignsController = __decorate([
    Controller('custom-designs'),
    __metadata("design:paramtypes", [CustomDesignsService])
], CustomDesignsController);
export { CustomDesignsController };
